	...
	iWebkit = window.onload = function () {
	    ...
	    iWebkit.popup = function () {
	        ...
	        if (window.navigator.standalone) {
                o_frame.className = 'confirm_screenopenfull'; 
            } 
	        else {
        ...
        iWebkit.closepopup = function () {
	        ...
	        if (window.navigator.standalone) {
                var o_framefull = o_parent.getElementsByClassName('confirm_screenopenfull')[0];
	            o_framefull.className = 'confirm_screenclose';
            } 
            else {
